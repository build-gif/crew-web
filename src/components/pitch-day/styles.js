...
export const PITCH_DAY_STYLES = `
  ...
  /* VC logos */
  .pd-logo-grid { display: grid; grid-template-columns: repeat(7, 1fr); gap: 14px; }
  .pd-logo-cell {
  ...
  .pd-logo-cell-wide img { padding: 12px 10px; }
  .pd-logo-cell-text {
  ...
  .pd-stakes .pd-inner { padding: 80px 0; }
  ...
  /* Final CTA */
  .pd-final { background: ${CREW.ink}; color: ${CREW.cream}; padding: 104px 0 112px; }
  ...
  @media (max-width: 900px) {
    ...
    .pd-logo-grid { grid-template-columns: repeat(4, 1fr); }
